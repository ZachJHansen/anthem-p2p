...
tff(completed_definition_more_than_three_1, axiom, ![X: object]: (more_than_three(X) <=> ?[N: $int]: ((($lesseq(1, N) & $lesseq(N, n)) & ~three(f__integer__(N)) & X = f__integer__(N))))).
...
% specs
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
tff(statement_1, conjecture, ![X: object]: (more_than_three(X) <=> ?[N1: $int]: ((?[N2: $int]: ((N2 = n & $lesseq(1, N1) & $lesseq(N1, N2))) & ~three_1(f__integer__(N1)) & X = f__integer__(N1))))).
