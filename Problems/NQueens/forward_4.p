...
tff(integrity_constraint, axiom, ![X: object]: (~(~q(X) & ?[N: $int]: (($lesseq(1, N) & $lesseq(N, n) & X = f__integer__(N)))))).
...
tff(statement_4, conjecture, ![X1: object, X2: object, X3: object, X4: object]: (~(q(X1, X2) & q(X3, X4) & X1 != X3 & ?[X5: object]: ((?[N1: $int, N2: $int]: ((X5 = f__integer__($difference(N1, N2)) & f__integer__(N1) = X1 & f__integer__(N2) = X3)) & ?[N3: $int, N4: $int]: ((X5 = f__integer__($difference(N3, N4)) & f__integer__(N3) = X2 & f__integer__(N4) = X4))))))).
