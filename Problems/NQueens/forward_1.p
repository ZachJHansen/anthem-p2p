...
% specs
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
tff(statement_1, conjecture, ![X1: object, X2: object]: (q(X1, X2) <=> (q(X1, X2) & ?[N1: $int, N2: $int]: ((N1 = n & $lesseq(1, N2) & $lesseq(N2, N1) & X1 = f__integer__(N2))) & ?[N3: $int, N4: $int]: ((N3 = n & $lesseq(1, N4) & $lesseq(N4, N3) & X2 = f__integer__(N4)))))).
