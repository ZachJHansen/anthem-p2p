...
tff(statement_5, conjecture, ![X1: object, X2: object, X3: object, X4: object]: (~(q(X1, X2) & q(X3, X4) & X1 != X3 & ?[X5: object]: ((?[N1: $int, N2: $int]: ((X5 = f__integer__($difference(N1, N2)) & f__integer__(N1) = X1 & f__integer__(N2) = X3)) & ?[N3: $int, N4: $int]: ((X5 = f__integer__($difference(N3, N4)) & f__integer__(N3) = X4 & f__integer__(N4) = X2))))))).
