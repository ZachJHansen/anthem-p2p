...
tff(completed_definition_q_2, conjecture, ![X1: object, X2: object]: (q(X1, X2) <=> (q(X1, X2) & ?[N1: $int]: (($lesseq(1, N1) & $lesseq(N1, n) & X1 = f__integer__(N1))) & ?[N2: $int]: (($lesseq(1, N2) & $lesseq(N2, n) & X2 = f__integer__(N2)))))).
