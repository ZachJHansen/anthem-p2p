...
% lemmas
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
tff(statement_1, conjecture, ![X: object, N1: $int, N2: $int]: ((($greater(N1, 1) & $greater(N2, 1) & X = f__integer__($product(N1, N2))) => (p__less_equal__(f__integer__(N1), X) & p__less_equal__(f__integer__(N2), X))))).
