...
% lemmas
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
tff(statement_1, axiom, ![X: object, N1: $int, N2: $int]: ((($greater(N1, 1) & $greater(N2, 1) & X = f__integer__($product(N1, N2))) => (p__less_equal__(f__integer__(N1), X) & p__less_equal__(f__integer__(N2), X))))).
...
tff(completed_definition_prime_1, conjecture, ![X: object]: (prime(X) <=> ?[N: $int]: ((($lesseq(a, N) & $lesseq(N, b)) & ~composite(f__integer__(N)) & X = f__integer__(N))))).
...
% specs
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
tff(statement_1, axiom, ![X: object]: (prime(X) <=> ?[N1: $int]: ((?[N2: $int, N3: $int]: ((N2 = a & N3 = b & $lesseq(N2, N1) & $lesseq(N1, N3))) & ~composite_1(f__integer__(N1)) & X = f__integer__(N1))))).
