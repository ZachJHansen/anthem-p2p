...
tff(completed_definition_p_1, axiom, ![X1: object]: (p(X1) <=> ?[X2: object]: ((?[N1: $int]: (($lesseq($uminus(n), N1) & $lesseq(N1, n) & X2 = f__integer__(N1))) & ?[N2: $int, N3: $int]: ((X1 = f__integer__($product(N2, N3)) & f__integer__(N2) = X2 & f__integer__(N3) = X2)))))).

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% specs
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
tff(statement_1, conjecture, ![X1: object]: (p(X1) <=> ?[X2: object]: ((?[N1: $int, N2: $int]: ((N1 = n & $lesseq(0, N2) & $lesseq(N2, N1) & X2 = f__integer__(N2))) & ?[N3: $int, N4: $int]: ((X1 = f__integer__($product(N3, N4)) & f__integer__(N3) = X2 & f__integer__(N4) = X2)))))).
