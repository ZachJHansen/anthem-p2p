...
tff(integrity_constraint, conjecture, ![X1: object, X2: object]: (~(~in_building(X1, X2) & person(X1) & ?[N: $int]: (($lesseq(0, N) & $lesseq(N, h) & X2 = f__integer__(N)))))).
...
tff(statement_2, axiom, ![X1: object, X2: object, X3: object, X4: object]: (~(in(X1, X2, X3) & in(X1, X4, X3) & X2 != X4))).
tff(statement_3, axiom, ![X1: object, X2: object]: (~(~in_building_1(X1, X2) & person(X1) & ?[N1: $int, N2: $int]: ((N1 = h & $lesseq(0, N2) & $lesseq(N2, N1) & X2 = f__integer__(N2)))))).
